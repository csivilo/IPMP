...
import numpy as np
import SecondaryModels.FitHuangFullTempModel as RFT
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Huang Square-root Model (full range) "
        np.seterr(all='ignore')
        self.calculation = RFT.FitHuangFullTemp(rawdata, self.p)
