...
import numpy as np
import SurvivalModels.FitWeibullMafartSurvivalModel as WMSM
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Weibull-Mafart Survival Model"
        np.seterr(all='ignore')
        self.calculation = WMSM.FitWeibullMafartSurvival(rawdata, self.p)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Y0', 'D', 'alpha']
        """
