...
import numpy as np
import SurvivalModels.FitBuchananTwoPhaseShoulderLinearSurvivalModel as BTSL
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Buchanan Shoulder-Linear Survival Model"
        np.seterr(all='ignore')
        self.calculation = BTSL.FitBuchananTwoPhaseShoulderLinearSurvival(rawdata, self.p)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Y0', 'k', 'Shoulder']
        """
