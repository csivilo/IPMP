...
import numpy as np
import SecondaryModels.FitRatkowskySubTempModel as RST
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Ratkowsky Square-root Model (suboptimal) "
        np.seterr(all='ignore')
        self.calculation = RST.FitRatkowskySubTemp(rawdata, self.p)
