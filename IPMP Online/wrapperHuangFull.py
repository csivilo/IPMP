...
import warnings
import numpy as np
import StaticFullGrowthModel.FitHuangFull as HF
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.calculation = HF.FitHuangFull(rawdata, p0)
        ...
        if self.calculation.errorMessage == "Successful":    
            self.confidenceIntervals = CI.ConfidenceIntervals(self.errorEstimate.MSE,  self.calculation.jacobian.jacob,\
