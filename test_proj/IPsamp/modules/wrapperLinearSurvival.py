...
import numpy as np
import SurvivalModels.FitLinearSurvivalModel as LSM
...
class dataAnalysis():
    def __init__(self, rawdata):
        ...
        self.modelName = "Linear Survival y = y0 - t/D"
        np.seterr(all='ignore')
        self.calculation = LSM.FitLinearSurvival(rawdata)
