...
import warnings
import numpy as np
import StaticIncompleteGrowthModels.FitTwoPhaseBuchanan as FTB
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Buchanan, two-phase (lag and exponential)"
        np.seterr(all='ignore')
        self.calculation = FTB.FitTwoPhaseBuchanan(rawdata, p0)
