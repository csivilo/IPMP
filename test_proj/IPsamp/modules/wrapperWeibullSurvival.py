...
import numpy as np
import SurvivalModels.FitWeibullSurvivalModel as WSM
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Weibull Survival Model"
        np.seterr(all='ignore')
        self.calculation = WSM.FitWeibullSurvival(rawdata, self.p)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Y0', 'K', 'alpha']
           ...
           5) upper 95% confidence limit: self.errorEstimate.parameterOutput[5]
            ...
            The outputs are listed as below 
                The first column = self.parametersList
                 ...
                 K 	 5.346E-01 	 2.163E-01 	 2.471 	 6.884E-02 	 -6.598E-02 	 1.135E+00
