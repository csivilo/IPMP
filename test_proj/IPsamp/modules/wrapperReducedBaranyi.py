...
import warnings
import numpy as np
import StaticIncompleteGrowthModels.FitReducedBaranyi as ICB
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Baranyi, reduced"
        np.seterr(all='ignore')
        self.calculation = ICB.FitReducedBaranyi(rawdata, p0)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = [ 'mumax','Y0', 'h0']
        """
        ...
        2. self.parameterOutput
                 ...
                 h0 	 1.127 	 0.205 	 5.507 	 1.179E-02 	 0.476 	 1.778                
