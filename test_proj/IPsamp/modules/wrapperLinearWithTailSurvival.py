...
import numpy as np
import SurvivalModels.FitLinearWithTailSurvivalModel as LWT
...
class dataAnalysis():
    def __init__(self, rawdata):
        ...
        self.modelName = "Linear Survival with Tail"
        np.seterr(all='ignore')
        self.calculation = LWT.FitLinearWithTailSurvival(rawdata)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Y0', 'D', 'Ytail']
        """
           ...
           5) upper 95% confidence limit: self.errorEstimate.parameterOutput[5]
            ...
            The outputs are listed as below 
                The first column = self.parametersList
                 ...
                 D 	   2.551 	 0.193 	     13.184 	9.429E-04 	 1.935 	 3.166
                 Ytail  
...
def main():
    ...
    calculation = dataAnalysis(rawdata)
