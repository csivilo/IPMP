...
import numpy as np
import SecondaryModels.FitHuangSubTempModel as RST
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Huang Square-root Model (suboptimal) "
        np.seterr(all='ignore')
        self.calculation = RST.FitHuangSubTemp(rawdata, self.p)
