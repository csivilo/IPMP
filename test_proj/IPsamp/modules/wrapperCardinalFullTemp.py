...
import numpy as np
import SecondaryModels.FitCardinalFullTempModel as RFT
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Cardinal Square-root Model (full range) "
        np.seterr(all='ignore')
        self.calculation = RFT.FitCardinalFullTemp(rawdata, self.p)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Tmin', 'Topt', 'Tmax', 'muopt']  
