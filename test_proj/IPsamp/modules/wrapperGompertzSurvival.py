...
import numpy as np
import SurvivalModels.FitGompertzSurvivalModel as GSM
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Gompertz Survival Model"
        np.seterr(all='ignore')
        self.calculation = GSM.FitGompertzSurvival(rawdata, self.p)
        ...
        #except (ValueError,  OverflowError, ZeroDivisionError, FloatingPointError): 
            ...
            pass
        self.parametersList = ['Y0', 'mumax', 'Lag']
        """
           ...
           5) upper 95% confidence limit: self.errorEstimate.parameterOutput[5]
            ...
            The outputs are listed as below 
                The first column = self.parametersList
                 ...
                 mumax 	 1.224 	 0.073 	 16.677 	 7.574E-05 	 1.020 	 1.427
                 Lag 	-0.062 	 0.500 	 -0.124 	 9.069E-01 	-1.451 	 1.326
