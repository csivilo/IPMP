...
import numpy as np
import SecondaryModels.FitRatkowskyFullTempModel as RFT
...
class dataAnalysis():
    def __init__(self, rawdata, p0):
        ...
        self.modelName = "Ratkowsky Square-root Model (full range) "
        np.seterr(all='ignore')
        self.calculation = RFT.FitRatkowskyFullTemp(rawdata, self.p)
